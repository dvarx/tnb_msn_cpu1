...
struct bridge_configuration cha_bridge={27,22,23,8,GPIO_8_EPWM5A,9,GPIO_9_EPWM5B,EPWM5_BASE,false,false};
struct driver_channel channela={0,&cha_bridge,READY,87};

// channel b
//struct buck_configuration chb_buck={35,60,15,GPIO_15_EPWM8B,14,GPIO_14_EPWM8A,EPWM8_BASE,true};
struct bridge_configuration chb_bridge={18,61,65,16,GPIO_16_EPWM9A,17,GPIO_17_EPWM9B,EPWM9_BASE,false,false};
struct driver_channel channelb={1,&chb_bridge,READY,85};

// channel c
//struct buck_configuration chc_buck={95,89,4,GPIO_4_EPWM3A,5,GPIO_5_EPWM3B,EPWM3_BASE,false};
struct bridge_configuration chc_bridge={19,133,93,14,GPIO_14_EPWM8A,15,GPIO_15_EPWM8B,EPWM15_BASE,false,false};
struct driver_channel channelc={2,&chc_bridge,READY,83};
...
struct driver_channel channeld={3,&chd_bridge,READY,71}; // TODO : resonant enable pin
...
struct driver_channel channele={4,&che_bridge,READY,73}; // TODO : resonant enable pin
...
struct driver_channel channelf={5,&chf_bridge,READY,126}; // TODO : resonant enable pin
