...
// channel d
struct buck_configuration chd_buck={0};
...
// channel e
struct buck_configuration che_buck={0};
...
// channel f
struct buck_configuration chf_buck={0};
...
// channel g
struct buck_configuration chg_buck={0};
struct bridge_configuration chg_bridge={32,53,56,2,GPIO_2_EPWM2A,3,GPIO_3_EPWM2B,EPWM2_BASE,false,true};
struct driver_channel channelg={6,&chg_buck,&chg_bridge,READY,0}; // TODO : resonant enable pin
