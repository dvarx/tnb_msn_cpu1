...
#ifdef USE_CALIBRATED_CURRENT_SENSORS
/*
 * use calibrated sensitivities and offsets
 ...
 * (e.g. if 2A are applied and 3A are measured, set the correctionf actor to 2/3)
 */
const float calib_factor_current_alphas[]={
                                           ...
                                           1.0  *   (-1.5/I_SENSITIVITY/2048),
                                           1.0  *   (-1.5/I_SENSITIVITY/2048)};
const float calib_factor_current_betas[NO_CHANNELS]={0};
#else
//use nominal sensitivities and offsets (note, current measurement is nominally inverted)
const float calib_factor_current_alphas[]={-1.5/I_SENSITIVITY/2048};
const float calib_factor_current_betas[NO_CHANNELS]={0};
#endif
